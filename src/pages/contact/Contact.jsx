...
const Contact = () => {
    const contactDetails = [
        ...
        },
        {
            ...
            title: 'اتصل بنا',
            description: 'اتصل بنا في أي وقت خلال 24 ساعة',
            ...
            <div className="contact-container mb-8">
                <Row gutter={[50, 50]}> 
                    ...
                    <Col xs={24} md={15} className="contact-right">
                        <TitleH title={'اتصل'} highlight={'بــنا'} />
                        <p>للتواصل معنا واستفساراتكم حول خدماتنا أو منتجاتنا، يرجى ملء النموذج التالي:</p>
                        ...
                        >
                            <Form.Item label="اسمك" name="name" rules={[{ required: true, message: 'يرجى إدخال اسمك' }]}>
                                <Input size='large' />
                            </Form.Item>
                            <Row gutter={[20, 20]} >
                                <Col span={12} >
                                    <Form.Item label="رقم الهاتف" name="phone" rules={[{ required: true, message: 'يرجى إدخال رقم هاتفك' }]}>
                                        <Input size='large' />
                                    </Form.Item>
                                </Col>
                                <Col span={12} >
                                    <Form.Item label="البريد الإلكتروني" name="email" rules={[{ required: true, message: 'يرجى إدخال بريدك الإلكتروني' }]}>
                            ...
                            <Form.Item label="اسم الشركة" name="company">
                                <Input size='large' />
                            </Form.Item>

                            <Form.Item label="رسالتك" name="message" rules={[{ required: true, message: 'يرجى إدخال رسالتك' }]}>
                        ...
                        <Col xs={24} md={12} className="address-content">
                            <div className="title">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
                                    <path d="M0 0H26C30.9706 0 35 4.02944 35 9V35L31.9794 10.8348C31.4687 6.74934 28.2507 3.53133 24.1652 3.02065L0 0Z" fill="#A61517" />
                                </svg>
                            </div>
                            <p>
                                3758 الطريق الجنوبي الشمالي - حي النفل الرياض
                                <br />
                                المملكة العربية السعودية 6525 - 13312
                            </p>
